...
: #1}}
\newcommand{\GPnote}[1]{{\color{purple}Gorjana
: #1}}
...
\subsection{SURE 2021}

SURE 2021 was a seven-week remote program that involved six faculty mentors and seven undergraduates. 
The admitted students were diverse in terms of gender, ethnics, race, and socioeconomic background. 
A hybrid gathering was held on August 5, 2021, to strengthen the communications between students and mentors. Each research group introduced the project they worked on together as the second figure in Figure \ref{fig:SURE2021}. After it, participants watched the White Sox game together. During the program, mentors met the students at least once a week and encouraged them to present their work in the research group seminar. Students presented their research work by slides or posters at the final presentation meeting.

\begin{figure}[h]
    \centering
     \includegraphics[width=0.35\linewidth]{SUREWebsite.png}
    \includegraphics[width=0.19\linewidth]{SURE2021Midterm.png}
    \includegraphics[width=0.265\linewidth]{SURE2021.png}
    \caption{SURE Website and SURE 2021 Group Photo}
    \label{fig:SURE2021}
\end{figure}


We collect feedback from the students after the following fall semester. Four participants provided their responses. All of them were willing to join the summer research experience in the future and valued the learning experience in SURE. They agreed SURE helped them understand the research process and learn to work independently. Their ability to analyze data and interpret results was enhanced after the program. Some students expected more practice in oral presentation and scientific writing. Two students are in graduate program now. One of them is a new coming Ph.D. student at Illinois Tech. He attended the Illinois Tech Poster Day session this summer. (See the second figure in Figure \ref{fig:SURE2022}). 
 Another student joined an REU Site at UCLA this summer. She will keep working with her SURE supervisor during the regular semester.
...
\emph{Day 2} features the tutorials.
 We will offer software tutorials in the morning. PIs will choose the programming language based on the needs of their projects and the participants. All participants will do a sample programming practice afterward. The afternoon tutorial will focus on technical writing, open scholarship, and reproducible research. Hands-on exercises will follow.
...
%We propose the following requirements for SURE students work on this project, the {\bf prerequisites} for students are
%\begin{itemize}
%    \item basic calculus and linear algebra;
%    \item introductory level of probability and statistics; 
%    \item programming skills using popular software such as R, Python, or Matlab.
%\end{itemize} Four sample research projects are described as follows.
...
\input{fh_yd_projects.tex}

%\input{yd_project3.tex}
...
SURE students
will reside in Illinois Tech McCormick Student Village or State Street Village. The furnished halls are suite-style, allowing students to interact  outside  the program. The halls provide WiFi, laundry
lounges, and meeting rooms. The McCormick Tribune Campus Center provides various dining options. Illinois Tech will give  SURE participants access to all facilities. 
...
active in their fields and have extensive experience mentoring undergraduates, ensuring the quality of mentoring activities and the program's success. 

\noindent \underline{\textit{PI Yuhan Ding}} first mentored an undergraduate capstone project in 2018 as a co-adviser. She also provided tutorials for MATLAB and LaTeX to undergraduates many times. In 2019, she advised three students in a summer research course. All of them are in master’s programs now. In 2021 fall, she supervised one undergraduate research in SoReMo and reviewed his final report. In the summers of 2021 and 2022, she coordinated the pilot programs of SURE.

\noindent \underline{\textit{Co-PI Fred Hickernell}} has supervised 16 PhD students, a handful of master's thesis students, and a couple of dozen undergraduate research students.  He has authored over a hundred refereed publications, including \cite{ChoEtal22a,HicEtal14b,LiHic03a,SonRidFasHic10a} with five undergraduates.  Undergraduates mentored by \FH have gone on to graduate programs at Johns Hopkins, Princeton U, RPI (an African-American), U Illinois Chicago (a Latina), and UCLA. \FH is a Fellow of the IMS and has served on the editorial boards of several computational mathematics journals. 
...
\begin{figure}[h]
    \centering
    {\footnotesize \textsf{
    \begin{tabular}{c>{\centering}p{23ex}>{\centering}p{12ex}>{\centering}p{33ex}}
          & Racial Minority  & Female & First Generation College Students  \tabularnewline \toprule
        SURE 2021 &  28.6\%  & 57.1\% & 42.8\%   \tabularnewline 
        SURE 2022 & 25\% & 0 \% & 25\%
    \end{tabular} }} \vspace{-2ex}
%    \includegraphics[width = 14cm]{FirstWeekSchedule.png}
    \caption{Percentage of Underrepresented Groups}
    \label{tab:PoUG}
\end{figure}
\fi
