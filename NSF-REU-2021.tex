...
%%% Ideas
\iffalse
https://www.iit.edu/TheChicagoDifference

Martha Razo  9:46 PM
Hello! I am doing good. Yes. I am doing my Phd in Industrial Engineering at UIC. I finished my first semester going onto the second this Fall.
...
Academic Tutorials:  linear algebra, probability and statistics, computational light light (depend on project)}


\subsection{Targeted Student Participants}
The targeted student participants will primarily be rising juniors or seniors with a solid background
in mathematics and statistics, including at least univariate calculus and programming.  In accordance with NSF regulations, all students must be Students from \hypertarget{MSIlink}Minority Serving Institutions (\MSIs) and institutions with limited research opportunities will be given high priority in the recruitment.  Undergraduate students that are veterans of the US armed services and first-generation college students will also be given priority. We will recruit our undergraduates fitting the following profile: 
\begin{enumerate}[1)]
 \item \emph{At least 60\%} from underrepresented groups including women, racial minorities, and persons with disabilities,
 \item \emph{At 30\%} underrepresented racial minorities,
...
generation of new methods in risk models, multi-variate integration and approximation, energetic variational inference, and pattern forming. The program will engage SURE
...
with day-to-day activities and to organize regular quarterly\FJHNote{What?} \YDNote{To keep track the research progress. Do you think this is necessary?} meetings during the academic
year among SURE participants and faculty mentors and to monitor their research progress. \YD
...
A \emph{seven-week}, internally funded, pilot program was hosted remotely in the summer of 2021, which involved \emph{six faculty mentors and seven undergraduate students}. This program was a collaboration between the departments of applied mathematics and computer science. Each student received a \$500 weekly stipend. \YD, the pilot program coordinator, handled selection of students and mentors, coordination of hybrid gatherings, social activities, and final presentations. \FH, \LK, and \SL served as mentors. \emph{Two of the undergraduates were racial minorities, four were female, one was a sexual minority, and three were first-generation college students.} All students provide very positive feedback about the program.
The detailed program information and comments from the participants can be found via  https://www.Illinois Tech.edu/computing/research/student-research/SURE.\FJHNote{We can put a link as a reference, but not necessarily as an active link.}
\YDNote{Change to a nonactive one}
...
% https://ima.org.uk/17278/disseminating-research-through-articles-and-blogs/
}
...
Office of Responsible Conduct of Research  Program will provide the presentation regarding \text{“Responsible Conduct of Research (RCR)”} to all SURE program participants. Office of Title IX Compliance will present Title IX Compliance to all the SURE students, faculty mentors and graduate students.
...
\bibliography{FJH23,FJHown23,EVI,kang,sc,Li}}
\end{document}
